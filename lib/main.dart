    ...
    return MultiProvider(
      ...
      child: Consumer<ThemeState>(
        builder: (context, theme, child) => MaterialApp(
          title: 'Android Pathu Client',
          initialRoute: '/',
          routes: {
            '/': (context) => const MyHomePage(title: 'Android Pathu Client'),
...
class _MyHomePageState extends State<MyHomePage> with TickerProviderStateMixin {
  ...
  Future<void> _requestPermissions() async {
    if (await Permission.bluetooth.request().isGranted &&
      ...
      _initBluetoothAndFirebase();
    }
  }

  void _initBluetoothAndFirebase() {
    FlutterBluetoothSerial.instance.requestEnable().then(
      (_) => scanBluetooth(),
    );
    Firebase.initializeApp(
      ...
      firestore?.collection('command').doc('move-to').snapshots().listen((
        event,
      ) {
        ...
        try {
          firestore?.collection('command').doc('move-to').update({
            direction: '__accepted__',
          });
        } catch (_) {}
        ;
      });
            ...
            Column(
              ...
              children: [
                ...
                ListTile(
                  ...
                  leading: const Icon(Icons.table_bar, size: 25.0),
                ...
                ListTile(
                  ...
                  textColor: Color.fromARGB(255, 255, 255, 255),
                  leading: const Icon(Icons.kitchen, size: 25.0),
                  iconColor: Color.fromARGB(255, 255, 255, 255),
                  onTap: () =>
                      _sendBluetooth(commandChar[Commands.gotokitchen]!),
                ),
                ...
                ListTile(
                  ...
                  leading: const Icon(Icons.stop_circle, size: 28.0),
                ...
                ListTile(
                  ...
                  leading: const Icon(Icons.mic, size: 25.0),
                      ...
                      onTap: () async {
                        if (_devAddr != device.address) {
                          try {
                            ...
                            if (await connectTodevice(device.address) == true) {
                              _connectingToAddr = '';
